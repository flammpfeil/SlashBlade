...
public class RenderPhantomSword extends Render {
    ...
    {
        if (entity instanceof EntityPhantomSword)
        {
            doDriveRender((EntityPhantomSword) entity, d0, d1, d2, f, f1);
        }
    }
    ...
    private void doDriveRender(EntityPhantomSword entityPhantomSword, double dX, double dY, double dZ, float f, float f1)
    {
