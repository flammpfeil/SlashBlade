 ...
 */
public class EntitySummonedSwordBase extends Entity implements IProjectile,IThrowableEntity {
    ...
    protected MovingObjectPosition getMovingObjectPosition(){
        ...
        if (movingobjectposition != null)
        {
            ...
            if(block != null)
                if(block.getCollisionBoundingBox(worldObj, pos, state) == null) movingobjectposition = null;
            else
