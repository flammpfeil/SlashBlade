    ...
    public boolean doTargeting() {
        ...
        if(targetid == 0){
            ...
            List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this
                    , this.getEntityBoundingBox().expand(expandFactor, expandFactor, expandFactor));
        ...
        if(targetid != 0 && getInterval() < this.ticksExisted ){
            ...
            if(target != null){
                ...
                float lastSpeed = (float)(new Vec3(this.motionX, this.motionY, this.motionZ)).lengthVector();
