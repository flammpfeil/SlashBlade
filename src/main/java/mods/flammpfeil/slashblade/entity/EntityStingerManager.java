 ...
 */
public class EntityStingerManager extends Entity implements IThrowableEntity {
    /**
     * ★撃った人
     */
    ...
    private static final DataParameter<Boolean> SINGLE_HIT = EntityDataManager.<Boolean>createKey(EntityStingerManager.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> LIFETIME = EntityDataManager.<Integer>createKey(EntityStingerManager.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> THROWER_ENTITY_ID = EntityDataManager.<Integer>createKey(EntityStingerManager.class, DataSerializers.VARINT);
    /**
     * ■イニシャライズ
     */
    @Override
        ...
        if(ticksExisted >= getLifeTime()) {
            ...
            if(!blade.isEmpty()){
                ...
                if(this.getThrower() != null && this.getThrower() instanceof EntityLivingBase) {
                    ...
                    this.getThrower().playSound(SoundEvents.ENTITY_GENERIC_EXPLODE, 0.5F, 2.5F);
                }
            }
