...
public class Fox {
    ...
    public void init(LoadEvent.InitEvent event){

        {
            ...
            ItemStack innerBlade = new ItemStack(Item.swordWood,1);
            ...
            loreList.appendTag(new NBTTagString("1","is demo item. is wooden sword"));
            loreList.appendTag(new NBTTagString("2","true performance : please crafting"));
    ...
    public void postInit(LoadEvent.PostInitEvent event){
...

        {
            ...
            ItemStack reqiredBlade = GameRegistry.findItemStack(SlashBlade.modid,"slashbladeWrapper",1);
            {
                ...
                reqiredBlade.setItemName("BambooMod katana");
            }
