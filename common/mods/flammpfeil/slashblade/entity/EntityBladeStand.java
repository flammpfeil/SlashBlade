...
public class EntityBladeStand extends Entity {
    ...
    static ItemStack emptyItem = new ItemStack(Item.stick);

    public ItemStack getBlade(){
    	ItemStack stack = this.dataWatcher.getWatchableObjectItemStack(WatchIndexBlade);

    	if(stack == null || stack.itemID == emptyItem.itemID)
    		return null;
    	else
    		return stack;
    }
    public void setBlade(ItemStack blade){
    	if(blade != null)
    		...
    		this.dataWatcher.updateObject(WatchIndexBlade, emptyItem);
    }
