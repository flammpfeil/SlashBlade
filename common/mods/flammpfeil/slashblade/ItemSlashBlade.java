...
public class ItemSlashBlade extends ItemSword {
	...
	public ItemSlashBlade(int par1, EnumToolMaterial par2EnumToolMaterial,float defaultBaseAttackModifier) {
